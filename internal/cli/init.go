...
func runInitInstall(st ShellType, explicitShell string) error {
	...
	for _, targetFile := range targetFiles {
		if content, err := os.ReadFile(targetFile); err == nil {
			if strings.Contains(string(content), "git-user init") {
...
# Add to ~/.zshrc or ~/.bashrc:  eval "$(git-user init)"
...
# Add to ~/.config/fish/config.fish:  git-user init fish | source
...
# Add to $PROFILE:  Invoke-Expression (& git-user init powershell)
